...
//+kubebuilder:webhook:path=/mutate-apps-birdhk-top-v1-application,mutating=true,failurePolicy=fail,sideEffects=None,groups=apps.birdhk.top,resources=applications,verbs=create;update,versions=v1,name=mapplication.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-apps-birdhk-top-v1-application,mutating=false,failurePolicy=fail,sideEffects=None,groups=apps.birdhk.top,resources=applications,verbs=create;update,versions=v1,name=vapplication.kb.io,admissionReviewVersions=v1
